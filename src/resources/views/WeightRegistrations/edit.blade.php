        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('WeightRegistrations.update', ['id' => $WeightRegistration->id])}}" method="POST">
                        @csrf
                        氏名
                        <input name="clint_name" type="text" value="{{$WeightRegistration->clint_name }}"><br>
                        生年月日
                        <input name="birth_date" type="date" value="{{$WeightRegistration->birth_date }}"><br>
                        性別
                        ...
                        測定年月
                        <input name="measurement_date" type="month" value="{{$WeightRegistration->measurement_date }}"><br>
